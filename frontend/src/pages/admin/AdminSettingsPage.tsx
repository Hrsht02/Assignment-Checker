...
export default function AdminSettingsPage() {
  ...
  const mutation = useMutation({
    mutationFn: () =>
      api.patch(`/admin/settings/similarity-threshold?threshold=${threshold / 100}`),
        ...
        <div className="card space-y-5">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-400">
              Submissions with similarity ≥ {threshold}% are flagged for professor review instead of being auto-rejected.
            </p>
            <input
              type="range"
              min={50}
